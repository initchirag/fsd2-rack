...
/**
 * Exp 2.1.1 — Bean Validation on incoming request body.
 * @NotBlank, @Size, @NotNull enforced before reaching the service layer.
 */
public class CreatePostRequest {
    ...
    // Setters (needed by Jackson deserialization)
